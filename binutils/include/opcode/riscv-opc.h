...
#define MATCH_SS_DMA_ADDR 0x107b
#define MASK_SS_DMA_ADDR  0xfe007fff
#define MATCH_SS_DMA_SCR 0x2b
#define MASK_SS_DMA_SCR  0x707f
#define MATCH_SS_SCR_DMA 0x302b
#define MASK_SS_SCR_DMA  0x707f
#define MATCH_SS_SCR_RD 0x102b
#define MASK_SS_SCR_RD  0x707f
#define MATCH_SS_DMA_RD 0x202b
#define MASK_SS_DMA_RD  0x707f
#define MATCH_SS_ATOMIC_SCR_OP 0x602b
#define MASK_SS_ATOMIC_SCR_OP 0x707f
#define MATCH_SS_CONST_SCR 0x605b
#define MASK_SS_CONST_SCR 0xfe007fff
...
#define MATCH_SS_WR 0x5b
#define MASK_SS_WR  0xfffff
#define MATCH_SS_DMA_ADDR_P 0x307b
#define MASK_SS_DMA_ADDR_P  0x707f
...
DECLARE_INSN(ss_cfg, MATCH_SS_CFG, MASK_SS_CFG)
DECLARE_INSN(ss_cfg_port, MATCH_SS_CFG_PORT, MASK_SS_CFG_PORT)
DECLARE_INSN(ss_ctx, MATCH_SS_CTX, MASK_SS_CTX)
DECLARE_INSN(ss_fill_mode, MATCH_SS_FILL_MODE, RMASK_SS_FILL_MODE)
DECLARE_INSN(ss_stride, MATCH_SS_STRIDE, MASK_SS_STRIDE)
DECLARE_INSN(ss_scr_rd, MATCH_SS_SCR_RD, MASK_SS_SCR_RD)
DECLARE_INSN(ss_dma_rd, MATCH_SS_DMA_RD, MASK_SS_DMA_RD)
DECLARE_INSN(ss_set_iter, MATCH_SS_SET_ITER, MASK_SS_SET_ITER)
DECLARE_INSN(ss_const, MATCH_SS_CONST, MASK_SS_CONST)
DECLARE_INSN(ss_recv, MATCH_SS_RECV, MASK_SS_RECV)
DECLARE_INSN(ss_garb, MATCH_SS_GARB, MASK_SS_GARB)
DECLARE_INSN(ss_wr_scr, MATCH_SS_WR_SCR, MASK_SS_WR_SCR)
DECLARE_INSN(ss_wr_dma, MATCH_SS_WR_DMA, MASK_SS_WR_DMA)
DECLARE_INSN(ss_wr_rd, MATCH_SS_WR_RD, MASK_SS_WR_RD)
DECLARE_INSN(ss_ind, MATCH_SS_IND, MASK_SS_IND)
DECLARE_INSN(ss_ind_wr, MATCH_SS_IND_WR, MASK_SS_IND_WR)
DECLARE_INSN(ss_atom_op, MATCH_SS_ATOMIC_SCR_OP, MASK_SS_ATOMIC_SCR_OP)
DECLARE_INSN(ss_const_scr, MATCH_SS_CONST_SCR, MASK_SS_CONST_SCR)
DECLARE_INSN(ss_cfg_ind, MATCH_SS_CFG_IND, MASK_SS_CFG_IND)
DECLARE_INSN(ss_cfg_atom_op, MATCH_SS_CFG_ATOM_OP, MASK_SS_CFG_ATOM_OP)
DECLARE_INSN(ss_wait, MATCH_SS_WAIT, MASK_SS_WAIT)
#endif
#ifdef DECLARE_CSR
